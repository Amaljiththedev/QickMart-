...
def update_stock(request):
        ...
        # Validate product_id
            ...
            # Update stock count
                ...
                return redirect('stock_management')  # Redirect to the inventory page after successful update
...
def order_management(request):
    if 'email' in request.session:
        ...
        # If it's a GET request, fetch orders and render the template
            ...
            return render(request, 'admin_auth/order_management.html', {'orders': orders})
    return render(request,'admin_auth/authentication-login.html')
...
def add_coupon(request):
    if request.method == 'POST':
        ...
        if code and discount_type and discount_value and min_order_value and expiration_date and max_uses:
