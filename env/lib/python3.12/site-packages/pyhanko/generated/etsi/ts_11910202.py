...
class ValidationReportDataType:
    ...
    additional_validation_report_data: Optional[AdditionalValidationReportDataType] = (
        field(
            default=None,
            metadata={
...
class ValidationObjectType:
    ...
    validation_object_representation: Optional[ValidationObjectRepresentationType] = (
        field(
            default=None,
            metadata={
